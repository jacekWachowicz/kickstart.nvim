...
-- Automatyczne i inteligentne wcięcia dla kodu (np. C)
...
require('lazy').setup({
  ...
  --
  {
    ...
    dependencies = {
      ...
      'nvim-tree/nvim-web-devicons', -- Zapewnia ikony (wymaga Nerd Font)
      'MunifTanjim/nui.nvim',
    },
    keys = {
      { '<leader>e', '<cmd>Neotree toggle<cr>', desc = 'Przełącz [E]ksplorator plików' },
    },
    opts = {
      window = {
        position = 'left',
